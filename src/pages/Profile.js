  ...
  return (
    <div class="container">
      ...
      <div class="visi">
        <h1>
          {" "}
          <span class="dot"></span> Visi <span class="dot"></span>{" "}
        </h1>
        <br></br>
        <p className="visi-p">
          {" "}
          Mewujudkan HIMSI sebagai wadah pemersatu yang kolaboratif dan adaptif{" "}
          <br></br> guna meningkatkan potensi, kemampuan, dan wawasan, serta
          kepribadian mahasiswa SI.
        </p>
      </div>
      ...
      <div class="misi">
        <h1>
          {" "}
          <span class="dot"></span> Misi <span class="dot"></span>{" "}
        </h1>
        <br></br>
        ...
        <div class="flex-container">
          ...
          <p className="misi-paragraf">
            Menjadikan kerjasama tim dan kolaborasi sebagai pondasi dalam
            menyelenggarakan maupun mengikuti segala kegiatan HIMSI maupun luar
            HIMSI.
          </p>
        </div>
        <br></br>
        ...
        <div class="flex-container">
          ...
          <p className="misi-paragraf">
            Mengoptimalkan potensi mahasiswa HIMSI dengan penyaluran minat bakat
            mahasiswa sesuai tujuan yang akan dicapai.
          </p>
        </div>
        <br></br>
        ...
        <div class="flex-container">
          ...
          <p className="misi-paragraf">
            Meningkatkan rasa kepedulian anggota HIMSI untuk terjun langsung ke
            masyarakat.
          </p>
        </div>
        <br></br>
        ...
        <div class="flex-container">
          ...
          <p className="misi-paragraf">
            Aktif menerima, mengevaluasi, dan menyampaikan aspirasi kepada pihak
        ...
        <div class="flex-container">
          ...
          <p className="misi-paragraf">
            Menjalin silaturahmi yang baik antar keluarga besar HIMSI, serta
            para individu dan organisasi yang terlibat di dalamnya.{" "}
          </p>
        </div>
      </div>
